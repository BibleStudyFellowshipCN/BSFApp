...
const initialState = {
  id: 0,
  name: 'BSF® Lesson 25',
  memoryVerse: '“Jesus commanded Peter, ‘Put your sword away! Shall I not drink the cup the Father has given me?’ ” – John 18:11',
  dayQuestions:  {
    one: {
      title: 'FIRST DAY: Read the notes and the references.',
      questions: [{
        id: 1,
    ...
    two: {
      title: 'SECOND DAY: Read John 18:28-32',
      read: [{
          book: '約翰福音',
          verse: '18:28-32',
        }],
      questions: [{
        id: 1,
        questionText: 'SECOND DAY: Read John 18:28-32',
        quotes: [{
          book: 'John',
          verse: '18:28-32',
        }],
        ...
        id: 2,
        questionText: '3. 猶太領袖為什麼不肯踏進彼拉多的官邸？他們去找彼拉多的理由顯出他們存心怎樣？（參閱馬可福音7:15。）',
        answer: '',
        quotes: [{
          book: '馬可福音',
          verse: '7:15',
        ...
        id: 3,
        questionText: '4. 猶太領袖為什麼要彼拉多來審判耶穌？彼拉多怎樣企圖推脫這責任？羅馬人的審訊和判刑怎樣影響了耶穌受死的方式？（參閱馬太福音20:18-19；約翰福音3: 14-16。）',
        answer: '',
        quotes: [{
          book: '馬太福音',
          verse: '20:18-19',
    ...
    three: {
      title: 'THIRD DAY: Read John 18:33-18:38.',
      read: [{
          book: 'John',
          verse: '18:33-18:38',
        }],
      questions: [{
        id: 0,
        questionText: 'THIRD DAY: Read John 18:33-18:38.',
        answer: '',
        quotes: [{
          book: '約翰福音',
          verse: '18:33-38',
        ...
        id: 1,
        questionText: '6. 請把彼拉多向耶穌提出的問題和耶穌的回答列出。（參閱約翰福音19:9-11。）',
        answer: '',
        quotes: [{
          book: '約翰福音',
          verse: '19:9-11',
    ...
    four: {
      title: 'FOURTH DAY: Read John 18:38-19:17.',
      questions: [{
        id: 1,
        ...
        id: 2,
        questionText: '10. 請列出彼拉多抗拒真理、行事不公的表現。他向要求把耶穌釘十字架的群眾屈服，可能因為什麼？（參閱馬太福音27:11-26；路加福音23:1-25。）',
        answer: '',
        quotes: [{
          book: '馬太福音',
          verse: '27:11-26',
    ...
    five: {
      title: 'FIFTH DAY: Read John 19:13-17.',
      questions: [{
        id: 1,
    ...
    six: {
      title: 'SIXTH DAY: Review John 18:28-19:17.',
      questions: [{
        id: 1,
